      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center p-6 bg-card rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-3 text-foreground">Feito com Amor</h3>
          ...
          <div className="text-center p-6 bg-card rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-3 text-foreground">Produtos Frescos</h3>
            <p className="text-muted-foreground">
          ...
          <div className="text-center p-6 bg-card rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-3 text-foreground">Tradição & Qualidade</h3>
            <p className="text-muted-foreground">
